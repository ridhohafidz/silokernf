...
<div class="row mt-4">
	<div class="col-md-9">
		<div class="card">
			...
			<form action="<?= base_url('admin/mitra_edit/'.$mitra->id) ?>" method="post" enctype="multipart/form-data"> 
			<div class="card-body">
				 
				  <div class="form-group row">
				    <label class="col-sm-3 col-form-label">Nama</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Nama" name="nama" required value="<?= $mitra->nama ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Alamat" name="alamat" required value="<?= $mitra->alamat ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Kontak" name="kontak" required value="<?= $mitra->kontak ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Telpon" name="telpon" required value="<?= $mitra->telpon ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Email" name="email" required value="<?= $mitra->email ?>">
				  ...
				  <div class="form-group row">
				    ...
				    <div class="col-sm-9">
				      <input type="text" class="form-control" placeholder="Web" name="web" required value="<?= $mitra->web ?>">
